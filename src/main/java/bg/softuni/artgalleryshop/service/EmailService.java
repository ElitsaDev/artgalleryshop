...
public class EmailService {
  ...
  public void sendRegistrationEmail(
    ...
    try {
      ...
      mimeMessageHelper.setFrom("artgallery@shop.com");
  ...
  public void sendResetPassEmail(String userEmail, String token) {
    MimeMessage mimeMessageResset = javaMailSender.createMimeMessage();
    try {
      MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mimeMessageResset);
      mimeMessageHelper.setFrom("artgallery@shop.com");
      mimeMessageHelper.setTo(userEmail);
      mimeMessageHelper.setText(token);
